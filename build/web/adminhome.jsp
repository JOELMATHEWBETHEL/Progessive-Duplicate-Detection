...
<div id="mycarousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="item active">
			<img src="images/pexels-photo (1).jpg" alt="" class="img-responsive">
...
<div class="row">
    <div class="card col-md-3">
        <span class="card-img-top glyphicon glyphicon-ok user1" alt="Card image cap"></span>
        <div class="card-block">
            <h4 class="card-title"><p class="lead"><center class="lead to-center"><a href="approveuser.jsp" class="card-link"></>APPROVE USER</a></center></p></h4>
         </div>
    </div>
    <div class="card col-md-3">
        <span class="card-img-top glyphicon glyphicon-remove user1" alt="Card image cap"></span>
        <div class="card-block">
            <h4 class="card-title"><p class="lead"><center class="lead to-center"><a href="approveuser.jsp" class="card-link">REJECT USER</a></center></p></h4>
        </div>
    </div>
    <div class="card col-md-3">
        <span class="card-img-top glyphicon glyphicon-eye-open user1" alt="Card image cap"></span>
        <div class="card-block">
            <h4 class="card-title"><p class="lead"><center class="lead to-center"><a href="viewuser.jsp" class="card-link">VIEW USER</a></center></p></h4>
        </div>
    </div>
</div>
<div class="row">
